...
const EmployeePredictInsuranceMember = () => {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {comparisonResults && (
          <div className="mt-8 p-4 border rounded-md shadow-md">
            ...
            <div>
              <h4 className="text-xl font-semibold text-green-600">Matched Data:</h4>
              <ul className="list-disc list-inside">
                {Object.entries(comparisonResults.matched_data).map(([key, value]) => (
                  <li className="flex items-center text-black" key={key}>
            ...
            <div className="mt-4">
              <h4 className="text-xl font-semibold text-red-600">Mismatched Data:</h4>
              <ul className="list-disc list-inside">
...
export default EmployeePredictInsuranceMember;
