...
function AdminClientDetails() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-center text-xl font-bold mt-3 text-black">Insurance Member Details</h1>
      <div className="flex flex-col md:flex-row justify-center mt-12">
        <div className="md:w-1/2 px-9">
          <p>
            ...
            <span className="text-blue-700 font-bold">{clientData.client_code}</span>
          </p>
          <p>
            <strong className="text-gray-500">First Name:</strong>{" "}
            <span className="font-bold text-slate-900">{clientData.first_name}</span>
          </p>
          <p>
            <strong className="text-gray-500">Last Name:</strong>{" "}
            <span className="font-bold text-slate-900">{clientData.last_name}</span>
          </p>
          <p>
          ...
          <p>
            ...
            <span className="font-bold text-slate-900">{clientData.gender}</span>
          </p>
          <p>
            <strong className="text-gray-500">Marital Status:</strong>{" "}
            <span className="font-bold text-slate-900">{clientData.marital_status}</span>
          </p>
          <p>
            <strong className="text-gray-500">Insurance Code:</strong>{" "}
            <span className="font-bold text-slate-900">{clientData.insurance?.insurance_code || "N/A"}</span>
          </p>
          <p>
            <strong className="text-gray-500">Insurance Name:</strong>{" "}
            <span className="font-bold text-slate-900">{clientData.insurance?.name || "N/A"}</span>
          </p>
          <p>
            <strong className="text-gray-500">Address:</strong>{" "}
            <span className="font-bold text-slate-900">{clientData.address}</span>
          </p>
        </div>

        <div className="md:w-1/2 mt-6 md:mt-0 md:pl-5">
          {clientData.picture && (
            <div className="mb-4">
          ...
          <p>
            ...
            <span className="font-bold text-slate-900">{new Date(clientData.created_date).toLocaleDateString()}</span>
          </p>
        </div>
      </div>
    </div>
